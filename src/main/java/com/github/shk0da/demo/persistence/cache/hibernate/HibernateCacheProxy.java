...
public class HibernateCacheProxy implements IgniteInternalCache<Object, Object> {
     ...
     */
    @Override
    public Iterable<Cache.Entry<Object, Object>> localEntries(
            CachePeekMode[] peekModes
    ) throws IgniteCheckedException {
     ...
     */
    @Override
    public Collection<CacheEntry<Object, Object>> getEntries(
     ...
     */
    @Override
    public IgniteInternalFuture<Collection<CacheEntry<Object, Object>>> getEntriesAsync(
     ...
     */
    @Override
    public IgniteInternalFuture<?> localLoadCacheAsync(
            @Nullable IgniteBiPredicate p,
            @Nullable Object... args
    ) {
    ...
    @Nullable
    @Override
    public EntryProcessorResult invoke(
     ...
     */
    @Override
    public IgniteInternalFuture<EntryProcessorResult> invokeAsync(
            Object key,
            EntryProcessor entryProcessor,
            Object... args
    ) {
     ...
     */
    @Override
    public Iterator<Cache.Entry<Object, Object>> scanIterator(
            boolean keepBinary,
            @Nullable IgniteBiPredicate p
    ) throws IgniteCheckedException {
